...
abstract class HexslatesModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexslatesModDependenciesExtension>("hexslatesModDependencies")
