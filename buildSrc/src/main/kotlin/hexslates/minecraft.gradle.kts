...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/hexslates.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hexslates-common-common-refmap.json
        // fixed:   hexslates-common.refmap.json
