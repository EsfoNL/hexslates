...
loom {
    forge {
        ...
        mixinConfig(
            "hexslates-common.mixins.json",
            "hexslates-forge.mixins.json",
        )
    }
    ...
    runs {
        for ((platform, outputProject) in arrayOf(
            ...
            register("${platform}Datagen") {
                ...
                property("hexslates.apply-datagen-mixin", "true")
                property("hexslates.$platform-datagen", "true")
            }
        }
    }
}

hexslatesModDependencies {
